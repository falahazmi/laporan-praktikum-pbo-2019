 ...
 * @author ASUS
 */
public class MyInputForm1841720085Falaah_edit extends JFrame {
    ...
    public MyInputForm1841720085Falaah_edit(){
        createTextField();
        createButton();
        createPanel();
    ...
    public static void main(String[] args) {
        JFrame frame = new MyInputForm1841720085Falaah_edit();
