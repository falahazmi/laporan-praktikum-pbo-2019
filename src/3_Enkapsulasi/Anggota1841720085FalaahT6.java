 ...
 * @author ASUS
 */
public class Anggota1841720085FalaahT6 
{
    private String ktp;
    private String nama;
    private int limit;
    ...
    Anggota1841720085FalaahT6(String ktp, String nama, int limit)
    {
        this.ktp = ktp;
        this.nama = nama;
        this.limit = limit;
    ...
    {
        if(uang < jmlPinjaman*10/100)
        {
            jmlPinjaman -= uang;
        }
        else
        {
            System.out.println("Maaf, angsuran anda harus 10% dari jumlah pinjaman");
        }
    }
}
